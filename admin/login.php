                        ...
                        <div class="login-form">
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" placeholder="Username.." id="username">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="login-checkbox">
                                    ...
                                    <label>
                                        <a href="forgot-pass.php">Forgotten Password?</a>
                                    </label>
                                </div>
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="button" id="submitBtn" onclick="adminLogin()">sign in</button>
